...
function tail () {
    return wind('npx tailwindcss -i ./app/css/main.css -o ./app/css/output.css --watch').exec();
}
function startwatch () {
...
exports.default = parallel(html, pugdev, style, scripts, serv, tail, startwatch);
